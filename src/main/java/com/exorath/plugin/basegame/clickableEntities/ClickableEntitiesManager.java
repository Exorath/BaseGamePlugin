 ...
 */
public class ClickableEntitiesManager implements Manager {
    private ClickEntAPI clickEntAPI;
    public ClickableEntitiesManager(Plugin plugin) {
        clickEntAPI = new ClickEntAPI(plugin);
    }

    public ClickEntAPI getClickEntAPI() {
        return clickEntAPI;
    }
}
